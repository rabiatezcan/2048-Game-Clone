...
public class Tile : MonoBehaviour {
	...
	void Update () {
		...
		textFab.GetComponent<UnityEngine.UI.Text>().transform.position = Camera.main.WorldToViewportPoint (transform.position);
	...
	void Change (int newValue) {
		...
		textFab.GetComponent<UnityEngine.UI.Text>().text = tileValue.ToString();
		// colour value which is written on our cell
		textFab.GetComponent<UnityEngine.UI.Text>().color = new Color (0.17f, 0.17f, 0.27f);
	}
