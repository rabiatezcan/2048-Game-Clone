...
public class Manager : MonoBehaviour {
	...
	void Start () {
		...
		highScoreText.GetComponent<UnityEngine.UI.Text>().text = "Best score : " + highscore;
	...
	void Update () {
        ...
        if(winner) {
			...
			youWonText.GetComponent<UnityEngine.UI.Text>().text = "Well done!"; // text
			// save the high score
			if(score > highscore) {
				highscore = score;
		...
		if(gameOver) {
			...
			youLoseText.GetComponent<UnityEngine.UI.Text>().text = "Game Over"; // text
			// save the high score
			if(score > highscore) {
				highscore = score;
				PlayerPrefs.SetInt("High Score", highscore);
